...
class DataProcessor:
    ...
    def process_data(self,topic,payload):
        ...
        '''if topic in ["monitoramento/temperatura","monitoramento/umidade"]:
            temperatura = payload if topic == "monitoramento/temperatura" else None
            umidade = payload if topic == "monitoramento/umidade" else None
            self.db.insert_into_database(temperatura,umidade)'''
